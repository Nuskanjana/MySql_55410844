package com.example.mysql_55410844;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				new CreatNewStudent().execute();
				
			}
		});
	}
	class CreatNewStudent extends  AsyncTask<String, String, String>{
@Override
protected void onPreExecute() {
	...
	pDialog.show();
		...
		protected String doInBackground(String... params) {
			...
			JSONObject jason = jsonParser.makeHttpRequest(url_create_student, 
					"POST", list);
			return null;
		}
		@Override
